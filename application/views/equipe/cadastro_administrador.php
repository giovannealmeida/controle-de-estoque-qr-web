                                        ...
                                        <td>
                                            <div class="margin-bottom-5">
                                                ...
                                                <?php if ($value->disabled == 0): ?>
                                                    <a class="btn btn-warning btn-sm" onclick="return confirm('Tem certeza que deseja desativar o administrador ?')" href="<?= base_url('Equipe/desativar_administrador?id=' . $value->id) ?>"><span class="glyphicon glyphicon-remove"></span> Desativar</a>
                                                <?php else: ?>
                                                    <a class="btn btn-warning btn-sm" onclick="return confirm('Tem certeza que deseja desativar o administrador ?')" href="<?= base_url('Equipe/ativar_administrador?id=' . $value->id) ?>"><span class="glyphicon glyphicon-remove"></span> Ativar</a>
                                                <?php endif; ?>
                                                <a class="btn btn-danger btn-sm" onclick="return confirm('Tem certeza que deseja excluir o administrador? Ao excluir um administrador será excluído todo o seu histórico no sistema, incluindo as vendas')" href="<?= base_url('Equipe/excluir_administrador?id=' . $value->id) ?>"><span class="glyphicon glyphicon-remove"></span> Remover</a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
